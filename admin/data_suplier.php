<br>
<div id="kolom">
<div id="judulkolom" align="left"><table cellspacing="10"><tr><td><b>Data Suplier</b></td></tr></table></div>
<br>
<table width="950px" cellspacing="0" align="center" style="font-family:Aller; font-size:14px; border:1px solid #2946AB;" border="1">
  <tr>
    ...
    <td width="217" class="tabelmenu" align="center">Kode Suplier</td>
    <td width="131" class="tabelmenu" align="center">Nama Suplier</td>
    <td width="172" class="tabelmenu" align="center">Alamat Suplier</td>
    <td width="120" class="tabelmenu" align="center">Kota Suplier</td>
...
$query   = "SELECT COUNT(*) as jumData FROM suplier";
$hasil  = mysqli_query($con,$query);
$data     = mysqli_fetch_array($hasil);
$jumData = $data['jumData'];

$sql=("select * from suplier LIMIT $offset, $dataPerPage");
...
while($c=mysqli_fetch_array($query2)){
	...
	<td>$c[nama_suplier]</td>
	<td>$c[alamat_suplier]</td>
	<td align='center'>$c[kota_suplier]</td>
	<td align='center'>$c[no_telepon]</td>
	"; ?>
<?php echo " 
<td align='center'><a href='cekedit_suplier.php?id=$c[0]'><input  type='submit' value='Edit' /></a> <a href='delete_suplier.php?id=$c[0]'><input  type='submit' value='Delete' /></a></td> ";?>
<?php echo "
	";
	$no++;
}
