...
<div id="header-dalam">
   ...
   <table align="left" cellspacing="0" style="background:#FFF;-webkit-border-radius:2px; -moz-border-radius:2px; margin-top:75px; margin-left:315px;
...
<div id="wrapper">
  <center>
  <div id="judul">
  <img src="images/NEWPRO.png" width="204" height="59" align="left" />
  </div>
  </center>
<div class="non-semantic-protector">
  ...
  <tr>
    <td><a class="kategori" href="dataproduk.php?page=tampil_bola"><img src="gambar/bola.png" width="150" height="150" /></a></td>
    <td><a class="kategori" href="dataproduk.php?page=tampil_celana"><img src="gambar/celana.png" width="150" height="150" /></a></td>
    <td><a class="kategori" href="dataproduk.php?page=tampil_jaket"><img src="gambar/jaket.png" width="150" height="150" /></a></td>
  </tr>
  <tr>
    <td><a class="kategori" href="dataproduk.php?page=tampil_jersey"><img src="gambar/jersey.png" width="150" height="150" /></a></td>
    <td><a class="kategori" href="dataproduk.php?page=tampil_kaos_kaki"><img src="gambar/koas kaki.png" width="150" height="150" /></a></td>
    <td><a class="kategori" href="dataproduk.php?page=tampil_sepatu"><img src="gambar/sepatu.png" width="150" height="150" /></a></td>
  </tr>
  <tr>
    <td><a class="kategori" href="dataproduk.php?page=tampil_tas"><img src="gambar/tas.png" width="150" height="150" /></a></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
</table>
...
$sql5=mysql_query("SELECT COUNT(vote) AS jumlahvote FROM voting WHERE vote='YA'");
$data_vote=mysql_result($sql5, 0);
$sql6=mysql_query("SELECT COUNT(vote) AS jumlahvote FROM voting WHERE vote='TIDAK'");
$data_vote2=mysql_result($sql6, 0);
?>
<table width="95%" border="0" cellspacing="3" cellpadding="0">
  <tr>
    <td><div style="height:20px; background-color:#06C; width:<?php echo $data_vote ?>px;"></div></td>
    <td align="left"><?php echo $data_vote." VOTE"; ?></td>
    <td align="right">YA</td>
    <tr>
    <td><div style="height:20px; background-color:#06C; width:<?php echo $data_vote2 ?>px;"></div></td>
    <td align="left"><?php echo $data_vote2." VOTE"; ?></td>
