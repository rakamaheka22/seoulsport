...
$query_ambil_produk	= mysql_query("SELECT * FROM barang WHERE jenis_barang='CELANA' ORDER BY kode_barang DESC LIMIT 0,3"); //query ambil data berita.
...
<?php
include "config/koneksi.php";
$query_ambil_produk	= mysql_query("SELECT * FROM barang WHERE jenis_barang='CELANA' ORDER BY kode_barang DESC LIMIT 3,3"); //query ambil data berita.
while ($data_produk = mysql_fetch_array($query_ambil_produk)) {
//perulangan untuk menampilkan berita 
?>
...
<?php
include "config/koneksi.php";
$query_ambil_produk	= mysql_query("SELECT * FROM barang WHERE jenis_barang='CELANA' ORDER BY kode_barang DESC LIMIT 6,3"); //query ambil data berita.
while ($data_produk = mysql_fetch_array($query_ambil_produk)) {
//perulangan untuk menampilkan berita 
?>
