...
$query_ambil_produk	= mysql_query("SELECT * FROM barang WHERE jenis_barang='SEPATU' ORDER BY kode_barang DESC LIMIT 0,3"); //query ambil data berita.
...
?>
<center><img align="middle" src="foto/<?php echo $data_produk['gambar_barang']; ?>" style="width: 180px; height: 100px; margin: 0 10px 10px 0; display: inline;"></center>
<?php 
} else {
	?>
...
<?php
include "config/koneksi.php";
$query_ambil_produk	= mysql_query("SELECT * FROM barang WHERE jenis_barang='SEPATU' ORDER BY kode_barang DESC LIMIT 3,3"); //query ambil data berita.
while ($data_produk = mysql_fetch_array($query_ambil_produk)) {
//perulangan untuk menampilkan berita 
?>
...
<?php
include "config/koneksi.php";
$query_ambil_produk	= mysql_query("SELECT * FROM barang WHERE jenis_barang='SEPATU' ORDER BY kode_barang DESC LIMIT 6,3"); //query ambil data berita.
while ($data_produk = mysql_fetch_array($query_ambil_produk)) {
//perulangan untuk menampilkan berita 
?>
