...
<div id="header-dalam">
    ...
    <div id="sosmed"> <a href="http://www.seoulsport.blogspot.com/"><img src="images/blo.PNG" width="100" height="100" /></a>
...
<div id="wrapper">
  <center>
  <div id="judul">
  <img src="images/trans.png" width="204" height="59" align="left" />
  </div>
  </center>
<div class="non-semantic-protector">
  ...
  <tr>
    ...
    <table width="95%" background="images/transback.PNG" cellpadding="20px">
    <tr>
    <td>
     <font face="neo Sans"><h3 style="margin-bottom: 0px">Transaksi Pemesanan</h3></font>
     <br />
        <?php
	...
	if($data=mysql_fetch_array($sql)){
		?>
    <form action="aksi_transaksi.php?id=<?php $data['0']; ?>" method="post">
    <font face="neo Sans" size="-1">
  ...
  <tr>
    <td>Kota</td>
    <td>:</td>
    <td><input type="text" name="kota_customer" /></td>
  </tr>
  <tr>
    <td>Alamat</td>
    <td>:</td>
  ...
  <tr>
    ...
    <td></td>
    <td></td>
    <td><br /><input id="btn1" type="submit" value="BELI" /></td>
  </tr>
</table>
</font>
    </form>
